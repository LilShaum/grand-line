(function (root) {
  ...
  var CREW = [
    { id: "swordsman",     name: "Swordsman",     role: "Crewmate", icon: "swords",    cost: 300,    bonus: "Sharpens your blade — +10% XP from Body (Strength) bounties.",        where: "Passive — always active",         effect: { type: "statXp", stat: "strength", mult: 0.10 } },
    { id: "navigator",     name: "Navigator",     role: "Crewmate", icon: "compass",   cost: 700,   bonus: "Unlocks the Voyage Map — a 12-week heatmap of your activity. Passive: +10% Wisdom XP.",        where: "Captain's Log",                   effect: { type: "statXp", stat: "wisdom",   mult: 0.10 } },
    { id: "sniper",        name: "Sniper",        role: "Crewmate", icon: "slingshot", cost: 1400,   bonus: "Unlocks Focus Shot — pin one bounty as your target for +25% reward. Passive: +10% Ambition XP.", where: "Bounty Board",                    effect: { type: "statXp", stat: "ambition", mult: 0.10 } },
    { id: "cook",          name: "Cook",          role: "Crewmate", icon: "flame",     cost: 2400,  bonus: "Runs the galley — health-tagged missions pay +50% Berries, and all missions pay +10% Berries.",         where: "Bounty Board",                    effect: { type: "berry", mult: 0.10 } },
    { id: "doctor",        name: "Doctor",        role: "Crewmate", icon: "cross",     cost: 3400,  bonus: "Unlocks the Wellness card — track health habits; they grant Strength XP. Passive: +15% journal XP.", where: "Ship Duties",                effect: { type: "journalXp", value: 0.15 } },
    { id: "archaeologist", name: "Archaeologist", role: "Crewmate", icon: "book",      cost: 5600, bonus: "Unlocks Poneglyph of the Day — a canon One Piece fact each day. Passive: +15% Wisdom XP.",     where: "Captain's Log",                   effect: { type: "statXp", stat: "wisdom",   mult: 0.15 } },
    { id: "shipwright",    name: "Shipwright",    role: "Crewmate", icon: "wrench",    cost: 4600, bonus: "Unlocks the Ship's Logbook (weekly recap) + 10% off all themes. Passive: +10% Resolve XP.",    where: "Captain's Log & the Hold",        effect: { type: "statXp", stat: "resolve",  mult: 0.10 } },
    { id: "musician",      name: "Musician",      role: "Crewmate", icon: "note",      cost: 4600, bonus: "Unlocks sea ambient audio — gentle background sound while you work. Passive: +15% Berries.", where: "The Helm (settings)",             effect: { type: "berry", mult: 0.15 } },
    { id: "helmsman",      name: "Helmsman",      role: "Crewmate", icon: "wheel",     cost: 8000, bonus: "Steadies the ship — raises your streak XP cap by +15%.",             where: "Passive — always active",         effect: { type: "streakCap", value: 0.15 } }
  ];
